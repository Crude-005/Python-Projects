...
_yellow=[['y1', 'Samaypur Badli'], ['y2', 'Rohini Sector 18,19'], ['y3', 'Haiderpur Badli Mor'], ['y4', 'Jahangirpuri'], ['y5', 'Adarsh Nagar'], ['y6', 'Azadpur'], ['y7', 'Model Town'], ['y8', 'GTB Nagar'], ['y9', 'Vishwavidyalaya'], ['y10', 'Vidhan Sabha'], ['y11', 'Civil Lines'], ['y12', 'Kashmere Gate'], ['y13', 'Chandni Chowk'], ['y14', 'Chawri Bazar'], ['y15', 'New Delhi'], ['y16', 'Rajiv Chowk'], ['y17', 'Patel Chowk'], ['y18', 'Central Secretariat'], ['y19', 'Udyog Bhawan'], ['y20', 'Lok Kalyan Marg'], ['y21', 'Jor Bagh'], ['y22', 'INA'], ['y23', 'AIIMS'], ['y24', 'Green Park'], ['y25', 'Hauz Khas'], ['y26', 'Malviya Nagar'], ['y27', 'Saket'], ['y28', 'Qutab Minar'], ['y29', 'Chhatarpur'], ['y30', 'Sultanpur'], ['y31', 'Ghitorni'], ['y32', 'Arjangarh'], ['y33', 'Guru Dronacharya'], ['y34', 'Sikandarpur'], ['y35', 'MG Road'], ['y36', 'IFFCO Chowk'], ['y37', 'Huda City Centre']]
_voilet=[['v1', 'Kashmere Gate'], ['v2', 'Lal Quila'], ['v3', 'Jama Masjid'], ['v4', 'Delhi Gate'], ['v5', 'ITO'], ['v6', 'Mandi House'], ['v7', 'Janpath'], ['v8', 'Central Secretariat'], ['v9', 'Khan Market'], ['v10', 'JLN Stadium'], ['v11', 'Jangpura'], ['v12', 'Lajpat Nagar'], ['v13', 'Moolchand'], ['v14', 'Kailash Colony'], ['v15', 'Nehru Place'], ['v16', 'Kalkaji Mandir'], ['v17', 'Govind Puri'], ['v18', 'Harkesh Nagar Okhla'], ['v19', 'Jasola Apollo'], ['v20', 'Sarita Vihar'], ['v21', 'Mohan Estate'], ['v22', 'Tughlakabad'], ['v23', 'Badarpur Border'], ['v24', 'Sarai'], ['v25', 'NHPC Chowk'], ['v26', 'Mewala Maharajpur'], ['v27', 'Sector-28'], ['v28', 'Badkal Mor'], ['v29', 'Old Faridabad'], ['v30', 'Neelam Chowk Ajronda'], ['v31', 'Bata Chowk'], ['v32', 'Escorts Mujesar'], ['v33', 'Sant Surdas (Sihi)'], ['v34', 'Raja Nahar Singh']]
_red=[['r1', 'Rithala'], ['r2', 'Rohini West'], ['r3', 'Rohini East'], ['r4', 'Pitampura'], ['r5', 'Kohat Enclave'], ['r6', 'Netaji Subhash Place'], ['r7', 'Keshav Puram'], ['r8', 'Kanhaiya Nagar'], ['r9', 'Inderlok'], ['r10', 'Shastri Nagar'], ['r11', 'Pratap Nagar'], ['r12', 'Pul Bangash'], ['r13', 'Tis Hazari'], ['r14', 'Kashmere Gate'], ['r15', 'Shastri Park'], ['r16', 'Seelampur'], ['r17', 'Welcome'], ['r18', 'Shahdara'], ['r19', 'Mansarovar Park'], ['r20', 'Jhilmil'], ['r21', 'Dilshad Garden'], ['r22', 'Shaheed Nagar'], ['r23', 'Raj Bagh'], ['r24', 'Rajendra Nagar'], ['r25', 'Shyam Park'], ['r26', 'Mohan Nagar'], ['r27', 'Hindon River Arthala'], ['r28', 'New Bus Adda']]
_magenta=[['m1', 'Botanical Garden'], ['m2', 'Okhla Bird Sanctuary  '], ['m3', 'Kalindi Kunj'], ['m4', 'Shaheen Bagh'], ['m5', 'Okhla Vihar'], ['m6', 'Jamia Millia Islamia'], ['m7', 'Sukhdev Vihar'], ['m8', 'Okhla NSIC'], ['m9', 'Kalkaji Mandir'], ['m10', 'Nehru Enclave'], ['m11', 'Greater Kailash'], ['m12', 'Chirag Delhi'], ['m13', 'Panchsheel Park'], ['m14', 'Hauz Khas'], ['m15', 'IIT'], ['m16', 'RK Puram'], ['m17', 'Munirka'], ['m18', 'Vasant Vihar'], ['m19', 'Shankar Vihar'], ['m20', 'Terminal 1- IGI Airport'], ['m21', 'Sadar Bazar Cantonment'], ['m22', 'Palam'], ['m23', 'Dashrath Puri'], ['m24', 'Dabri Mor'], ['m25', 'Janak Puri West']]
_pink=[['p1', 'Majlis Park'], ['p2', 'Azadpur'], ['p3', 'Shalimar Bagh'], ['p4', 'Netaji Subhash Place'], ['p5', 'Shakurpur'], ['p6', 'Punjabi Bagh'], ['p7', 'ESI Hospital'], ['p8', 'Rajouri Garden'], ['p9', 'Mayapuri'], ['p10', 'Naraina Vihar'], ['p11', 'Delhi Cantonment'], ['p12', 'Durgabai Deshmukh South Campus'], ['p13', 'Sir Vishweshwaraiah Moti Bagh'], ['p14', 'Bhikaji Cama Place'], ['p15', 'Sarojini Nagar'], ['p16', 'INA'], ['p17', 'South Extension'], ['p18', 'Lajpat Nagar'], ['p19', 'Vinobapuri'], ['p20', 'Ashram'], ['p21', 'Hazrat Nizamuddin'], ['p22', 'Mayur Vihar I'], ['p23', 'Mayur Vihar Pocket 1'], ['p24', 'Trilokpuri'], ['p25', 'East Vinod Nagar - Mayur Vihar-II'], ['p26', 'Mandawali West Vinod Nagar'], ['p27', 'IP Extension'], ['p28', 'Anand Vihar'], ['p29', 'Karkarduma'], ['p30', 'Karkarduma Court'], ['p31', 'Krishna Nagar'], ['p32', 'East Azad Nagar'], ['p33', 'Welcome'], ['p34', 'Jafrabad'], ['p35', 'Maujpur'], ['p36', 'Gokulpuri'], ['p37', 'Johri Enclave'], ['p38', 'Shiv Vihar']]
_green=[['g1', 'Inderlok'], ['g2', 'Ashok Park Main'], ['g3', 'Punjabi Bagh'], ['g4', 'Shivaji Park'], ['g5', 'Madipur'], ['g6', 'Paschim Vihar (East)'], ['g7', 'Paschim Vihar (West)'], ['g8', 'Peera Garhi'], ['g9', 'Udyog Nagar'], ['g10', 'Maharaja Surajmal Stadium'], ['g11', 'Nangloi'], ['g12', 'Nangloi Railway Station'], ['g13', 'Rajdhani Park'], ['g14', 'Mundka'], ['g15', 'Mundka Industrial Area (MIA)'], ['g16', 'Ghevra Metro Station'], ['g17', 'Tikri Kalan'], ['g18', 'Tikri Border'], ['g19', 'Pandit Shree Ram Sharma'], ['g20', 'Bahadurgarh City'], ['g21', 'Brigadier Hoshiyar Singh']]
_bgreen=[['G1', 'Ashok Park Main'], ['G2', 'Satguru Ram Singh Marg'], ['G3', 'Kirti Nagar']]
...
_bblue=[['B1', 'Yamuna Bank'], ['B2', 'Laxmi Nagar'], ['B3', 'Nirman Vihar'], ['B4', 'Preet Vihar'], ['B5', 'Karkar Duma'], ['B6', 'Anand Vihar'], ['B7', 'Kaushambi'], ['B8', 'Vaishali']]
_aqua=[['a1', 'Noida Sector 51'], ['a2', 'Noida Sector 50'], ['a3', 'Noida Sector 76'], ['a4', 'Noida Sector 101'], ['a5', 'Noida Sector 81'], ['a6', 'NSEZ'], ['a7', 'Noida Sector 83'], ['a8', 'Noida Sector 137'], ['a9', 'Noida Sector 142'], ['a10', 'Noida Sector 143'], ['a11', 'Noida Sector 144'], ['a12', 'Noida Sector 145'], ['a13', 'Noida Sector 146'], ['a14', 'Noida Sector 147'], ['a15', 'Noida Sector 148'], ['a16', 'Knowledge Park II'], ['a17', 'Pari Chowk'], ['a18', 'Alpha 1'], ['a19', 'Delta 1'], ['a20', 'GNIDA Office'], ['a21', 'Depot']]
_orange=[['o1', 'Dwarka Sector – 21'], ['o2', 'IGI Airport'], ['o3', 'Delhi Aerocity'], ['o4', 'Dhaula Kuan'], ['o5', 'Shivaji Stadium'], ['o6', 'New Delhi']]
_grey=[['g1', 'Dwarka'], ['g2', 'Nangli'], ['g3', 'Najafgarh'], ['g4', 'Dhansa Bus Stand']]    
_rapid=[['R1', 'Sector 55 56'], ['R2', 'Sector 54 Chowk'], ['R3', 'Sector 53 54'], ['R4', 'Sector 42 43'], ['R5', 'Phase 1'], ['R6', 'Sikandarpur'], ['R7', 'Phase 2'], ['R8', 'Vodafone Belvedere Towers'], ['R9', 'Indusland Cyber City'], ['R10', 'Micromax Moulsari Avenue'], ['R11', 'Phase 3']]

_lines=[_yellow, _voilet, _red, _magenta, _pink, _green, _bgreen, _bblue, _blue, _orange, _aqua, _grey, _rapid]
...
_junction = ['Kashmere Gate', 'Central Secretariat', 'Hauz Khas', 'Azadpur', 'INA', 'Rajiv Chowk', 'New Delhi', 'Kalkaji Mandir', 'Lajpat Nagar', 'Mandi House', 'Netaji Subhash Place', 'Welcome', 'Inderlok', 'Botanical Garden', 'Janak Puri West', 'Punjabi Bagh', 'Anand Vihar', 'Rajouri Garden', 'Ashok Park Main', 'Kirti Nagar', 'Yamuna Bank', 'Dwarka Sector – 21']
...
def double(_start , _end):
    ...
    for i in range(len(l2)):
        r=abs(int(l2[i][0][2][1:]) - int(l2[i][1][2][1:])) + abs(int(l2[i][2][2][1:])-int(l2[i][3][2][1:]))
        st_count.append(r)
        continue
    if st_count == []:
        s_route = []
    ...
    while r > -1:
        if r == 0:
            ...
            if l1 == []:
                ...
                print (f"Start at {l1[0][1]} - {l1[0][0][1:]} line to {l1[1][1]} - {l1[1][0][1:]} line ")
                r= -1
        elif r == 1 :
